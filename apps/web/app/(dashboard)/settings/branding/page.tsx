...
export default function BrandingPage() {
  ...
  const hasCustomBranding = orgName !== 'Frame' || orgLogoDark !== null || orgLogoLight !== null
      ...
      <section className="space-y-3">
        ...
        <div className="p-4 rounded-lg border border-border bg-bg-secondary space-y-3">
          ...
          <p className="text-xs text-text-tertiary">
            Shown in the sidebar. Defaults to &ldquo;Frame&rdquo;.
          </p>
        </div>
      </section>
        ...
        <div className="rounded-lg border border-border bg-bg-secondary p-4 flex items-center gap-2.5">
          <div className="h-7 w-7 rounded-md overflow-hidden flex items-center justify-center bg-bg-tertiary shrink-0">
            {activeLogo ? (
              ...
              <>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/logo-icon.png" alt="Frame" className="h-6 w-6 object-contain logo-dark" />
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/logo-icon-dark.png" alt="Frame" className="h-6 w-6 object-contain logo-light" />
              </>
            )}
          </div>
