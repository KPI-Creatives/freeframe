...
Instead, report vulnerabilities by emailing **security@freeframe.io** or via [GitHub Security Advisories](https://github.com/Techiebutler/freeframe/security/advisories/new).
